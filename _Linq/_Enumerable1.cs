...
namespace _Linq
{
    public static partial class _Enumerable_01
    {
        public static IEnumerable<TSource> Where<TSource>(this IEnumerable<TSource> source, int[] arr, Func<TSource, bool> predicate)
        {
        ...
        public static IEnumerable<TSource> Take<TSource>(this IEnumerable<TSource> source, int[] arr, int count)
        {
            if (source == null) throw new ArgumentNullException("source");
        ...
        public static IEnumerable<TSource> TakeWhile<TSource>(this IEnumerable<TSource> source, int[] arr, Func<TSource, int, bool> predicate)
        {
            if (source == null) throw new ArgumentNullException("source");
            if (predicate == null) throw new ArgumentNullException("predicate");
            return TakeWhileIterator<TSource>(source, predicate);
